...
\section*{Implementation}
  ...
  \subsection*{Apportioning Cost}
    ...
    \subsubsection*{Computing Cost}
      ...
      Using the corresponding information in the graph and our associated equations, we can compute a cost for \textit{D}.
      ...
      Consider \textit{E} which has three paths.
      They are documented in the section on \textbf{Path Enumeration} and
      are highlighted in Figures~\ref{figure:5},~\ref{figure:6},~\ref{figure:7}.

      \begin{figure}[H]
        \centering
        \includegraphics[width=\linewidth]{./truth-and-reconciliation-cost-ep1.png}
        \caption{Path 1 for E}
        \label{figure:5}
      \end{figure}
  ...
  \subsection*{Reconciling Cost}
    ...
    What's left at the end is an approach that balances.
    Since cost is distributed proportionately, we're able to ensure cost is properly attributed throughout the system.
